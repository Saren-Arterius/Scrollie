...
public enum Lang {
    ...
    LIST_PATTERN2("list-pattern2", "(D: {0}, W: {1}, C: {2}, CW: {3}, T: {4}, EXP: {5})"),
    ...
    FACTION_EXCEPTION("faction-exception", "Error in hooking into Factions! Please contact server administrators."),
    VAULT_EXCEPTION("vault-exception", "Error in hooking into Vault! Please contact server administrators."),
    ...
    YOU_HAVE_NO_HOME("you-have-no-home", "You don't have a home. Right click on a bed to set your home."),
    YOU_ARE_NOT_FACTION_MEMBER("you-are-not-faction-member", "You are not a member of any faction!"),
